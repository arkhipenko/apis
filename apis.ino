...
//Task tTimesync  (TASK_MINUTE, TASK_FOREVER, &timeSyncCallback, &ts, true);
#ifdef _TEST_
...
void settingsDoTout() {
  ...
  measurePowerupCallback();  // always measure after settings changed in case new limits were set
